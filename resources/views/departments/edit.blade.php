                            ...
                            <form class="settings-form" action="{{ route('department.update', $department->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="enter the department name" value="{{ $department->name }}">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code"
                                        placeholder="enter the department code" value="{{ $department->code }}">
                                    @error('code')
                                        <p class="text text-danger mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control textarea" id="description" name="description"
                                        placeholder="enter the department descritpion">{{ $department->description }}</textarea>
                                    @error('description')
                                        <p class="text text-danger mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="section" id="section">
                                        <option value="french" {{$department->section == "french" ? 'selected' : ''}}>French</option>
                                        <option value="english" {{$department->section == "english" ? 'selected' : ''}}>English</option>
                                    </select>
                                    @error('section')
                                        <p class="text text-danger mt-2">{{ $message }}</p>
                                    @enderror
