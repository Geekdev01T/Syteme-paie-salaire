    ...
    @section('content')
        <div class="container-xl">
            ...
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                ...
                @endif
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">Administrators List</h1>
                </div>
                <div class="col-auto">
            ...
            <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4"
                role="tablist">
                <a class="flex-sm-fill text-sm-center nav-link" id="admins-all-tab" data-bs-toggle="tab"
                    href="#admins-all">All</a>
            ...
            <div class="tab-content" id="orders-table-tab-content">
                <div class="tab-pane fade" id="admins-all" role="tabpanel">
                ...
                <div class="tab-pane fade" id="admins-intermittent" role="tabpanel">
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($admins as $admin)
                                            @if ($admin->email_verified_at)
                                                <tr>
                                                    <td class="cell">{{ str_pad(++$veriAdm, 2, '0', STR_PAD_LEFT) }}</td>
                                                    <td class="cell">
                                                        <span class="truncate">{{ $admin->name }}</span>
                                                    </td>
                                                    <td class="cell">{{ $admin->email }}</td>
                ...
                <div class="tab-pane fade" id="admins-permanent" role="tabpanel">
                    <div class="app-card app-card-orders-table mb-5">
                        <div class="app-card-body">
                            <div class="table-responsive">
                                <table class="table mb-0 text-left">
                                    ...
                                    <tbody>
                                        @forelse ($admins as $admin)
                                            @if (!$admin->email_verified_at)
                                                <tr>
                                                    <td class="cell">{{ str_pad(++$NoVeriAdm, 2, '0', STR_PAD_LEFT) }}</td>
                                                    <td class="cell">
                                                        <span class="truncate">{{ $admin->name }}</span>
                                                    </td>
                                                    <td class="cell">{{ $admin->email }}</td>
        ...
        <script>
            ...
            if (tabNav && tabContent) {
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    const validTabs = ['#admins-all', '#admins-intermittent', '#admins-permanent'];
