...
@section('title-content')
    <title> Create - Admin | StaffPay</title>
@endsection
...
<body>
    @section('content')
        <div class="container-xl">
            ...
            @endif
            <h1 class="app-page-title">Administrators</h1>
            <hr class="mb-4">
            <div class="row g-4 settings-section">
                <div class="col-12 col-md-2">
                    <h3 class="section-title">Add</h3>
                    <div class="section-intro">add a new admin here</div>
                </div>
                <div class="col-12 col-md-10">
                    <div class="app-card app-card-settings shadow-sm p-4">

                        <div class="app-card-body">
                            <form class="settings-form" action="{{ route('admin.store') }}" method="POST" >
                                @csrf
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="enter the admin's name" value="{{ old('name') }}">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                        placeholder="enter the admin's email" value="{{ old('email') }}">
                                    @error('email')
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" id="password" name="password"
                                        placeholder="enter the admin's password" value="{{ old('password') }}">
                                    @error('password')
                                        <p class="text text-danger mt-2">{{ $message }}</p>
                                    @enderror
                                </div> --}}
