...
@section('title-content')
    <title> List - Course | StaffPay</title>
@endsection
    ...
    @section('content')
        <div class="container-xl">
            ...
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">Courses List</h1>
                </div>
                <div class="col-auto">
            ...
            <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4"
                role="tablist">
                <a class="flex-sm-fill text-sm-center nav-link" id="courses-all-tab" data-bs-toggle="tab"
                    href="#courses-all">All</a>
                <a class="flex-sm-fill text-sm-center nav-link" id="courses-french-tab" href="#courses-french"
                    data-bs-toggle="tab">French Section</a>
                <a class="flex-sm-fill text-sm-center nav-link" id="courses-english-tab" data-bs-toggle="tab"
                    href="#courses-english">English Section</a>
            </nav>


            <div class="tab-content" id="orders-table-tab-content">
                <div class="tab-pane fade" id="courses-all" role="tabpanel">
                                    ...
                                    <tbody>
                                        @forelse ($courses as $index => $course)
                                            <tr>
                                                ...
                                                <td class="cell"><span
                                                        class="truncate">{{ $course->departement->name }}</span>
                                                </td>
                                                <td class="cell">
                                                    <a class="btn-sm app-btn-secondary"
                                                        href="{{ route('course.show', $course->id) }}">Show</a>
                                                    <a class="btn-sm app-btn-secondary"
                ...
                <div class="tab-pane fade" id="courses-french" role="tabpanel">
                                ...
                                <table class="table mb-0 text-left">
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($courses as $course)
                                            @if ($course->section == 'french')
                                                <tr>
                                                    <td class="cell">{{ str_pad(++$coursefr, 2, '0', STR_PAD_LEFT) }}</td>
                                                    <td class="cell"><span
                                                            class="truncate">{{ $course->name }}</span>
                                                    </td>
                                                    <td class="cell">{{ $course->code }}</td>
                                                    <td class="cell"><span
                                                            class="truncate">{{ $course->departement->name  }}</span>
                                        ...
                                        @if ($coursefr == 0)
                                            <tr>
                                                <td colspan="6" class="text-center">No french course found.</td>
                                            </tr>
                                        @endif
                ...
                <div class="tab-pane fade" id="courses-english" role="tabpanel">
                    <div class="app-card app-card-orders-table mb-5">
                        <div class="app-card-body">
                            <div class="table-responsive">
                                <table class="table mb-0 text-left">
                                    ...
                                    <tbody>
                                        @forelse ($courses as $course)
                                            @if ($course->section == 'english')
                                                <tr>
                                                    <td class="cell">{{ str_pad(++$courseen, 2, '0', STR_PAD_LEFT) }}</td>
                                                    <td class="cell"><span
                                                            class="truncate">{{ $course->name }}</span>
                                                    </td>
                                                    <td class="cell">{{ $course->code }}</td>
                                        ...
                                        @if ($courseen == 0)
                                            <tr>
                                                <td colspan="6" class="text-center">No english course found.</td>
                                            </tr>
                                        @endif
        ...
        <script>
            ...
            if (tabNav && tabContent) {
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    const validTabs = ['courses-all', '#courses-french', '#courses-english'];
